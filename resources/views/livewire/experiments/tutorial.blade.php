                    ...
                    <div class="flex h-full">
                        <div class="flex flex-col justify-center w-1/2 h-full px-44">
                            <div class="w-2/3 h-80">
                                ...
                                <div class="mt-4">
                                    <p class="text-pricy-gray-200 text-pricy-sm">Step <span x-text="currentStep"></span>
                                        of
                                        <span x-text="totalSteps"></span>
                                    </p>
                                </div>
                                <div class="mt-4">
                                    <h1 class="font-semibold text-pricy-lg text-pricy-gray-400" x-text="swiper.title">
                                    </h1>
                                </div>
                                <div>
            ...
            <div class="flex h-full">
                <div class="flex flex-col justify-between w-1/2 px-24 py-24">
                    <div>
                        ...
                        <div class="mt-4">
                            <p class="text-pricy-gray-200 text-pricy-sm">Step <span x-text="currentStep"></span> of
                                <span x-text="totalSteps"></span>
                            </p>
                        </div>
                        <div class="mt-4">
                            <h1 class="font-semibold text-pricy-lg text-pricy-gray-400" x-text="swipers[0].title"> </h1>
                        </div>
                        <div>
                            <p class="leading-loose text-pricy-sm text-pricy-gray-200" x-text="swipers[0].description">
                            </p>
                        </div>
                    </div>
                ...
                <div class="flex flex-col items-center justify-center w-1/2 h-full px-6 bg-pricy-yellow">
                    ...
                    <div class="flex justify-between w-full px-12 mt-32">
                        ...
                        <div class="flex space-x-1 cursor-pointer" @click="currentStep++">
                            <p>Next</p>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.8125 11.7942H3.5625" stroke="#1B2124" stroke-width="1.125"
            ...
            <div class="flex h-full">
                <div class="flex flex-col justify-between w-1/2 px-24 py-24">
                    <div>
                        ...
                        <div class="mt-4">
                            <h1 class="font-semibold text-pricy-lg text-pricy-gray-400" x-text="swipers[1].title"></h1>
                        </div>
                        <div>
                            <p class="leading-loose text-pricy-sm text-pricy-gray-200" x-text="swipers[1].description">
                            </p>
                        </div>
                    </div>
                    <div class="flex space-x-3">
            ...
            <div class="flex h-full">
                <div class="flex flex-col justify-between w-1/2 px-24 py-24">
                    <div>
                        ...
                        <div class="mt-4">
                            <h1 class="font-semibold text-pricy-lg text-pricy-gray-400" x-text="swipers[2].title">
                            </h1>
                        </div>
                        <div>
                            <p class="leading-loose text-pricy-sm text-pricy-gray-200" x-text="swipers[2].description">
                            </p>
                        </div>
                    </div>
                    <div class="flex space-x-3">
                ...
                <div class="flex flex-col items-center justify-center w-1/2 h-full px-6 bg-pricy-yellow">
                    ...
                    <div class="flex justify-between w-full px-12 mt-32">
                        ...
                        <template x-if="currentStep != totalSteps">
                            <div class="flex space-x-1" @click="currentStep++">
                                <p>Next</p>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.8125 11.7942H3.5625" stroke="#1B2124" stroke-width="1.125"
