<div class="container flex flex-col items-center w-2/3 mx-auto">
    <div class="flex flex-col items-center">
        <h1 class="font-semibold text-pricy-gray-400 text-pricy-large">Create an expirement</h1>
        <p class="mt-3 text-pricy-gray-300 text-pricy-base">In which strategy would you like to create your expirement
            today?</p>
    </div>
    <div class="grid grid-cols-3 mt-24 gap-x-16">
        <div class="flex flex-col px-6 py-8 transition-all duration-200 rounded-3xl hover:bg-pricy-gray-100">
            ...
            <div class="mt-2">
                <p class="leading-loose text-pricy-gray-300 text-pricy-sm">compare different prices of your products to
                    determine
                    which performs
            ...
            <div class="mt-6">
                <button class="px-5 py-3 text-xs font-medium text-gray-100 bg-gray-900 rounded">Choose a
                    strategy</button>
            </div>
        </div>
        <div class="flex flex-col px-6 py-8 transition-all duration-200 rounded-3xl hover:bg-pricy-gray-100">
